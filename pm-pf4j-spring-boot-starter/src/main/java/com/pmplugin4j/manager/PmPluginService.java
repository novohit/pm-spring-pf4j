...
/** Serializes global and per-plugin lifecycle operations. */
public class PmPluginService {

    private final PmPluginManager pluginManager;
    private final Object globalLock = new Object();

    public PmPluginService(PmPluginManager pluginManager) {
        this.pluginManager = pluginManager;
    }

    public void loadAndStartAllPlugins(Collection<String> enabledPluginIds) {
        synchronized (globalLock) {
            pluginManager.loadPlugins();
            pluginManager.startPlugins(enabledPluginIds);
        }
    }
