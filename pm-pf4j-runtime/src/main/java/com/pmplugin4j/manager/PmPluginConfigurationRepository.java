...
public class PmPluginConfigurationRepository implements ConfigurationRepository {

    private static final Logger log = LoggerFactory.getLogger(PmPluginConfigurationRepository.class);

    public static final String CONFIG_FILE_EXTENSION = ".properties";

    private final Path configRoot;

    public PmPluginConfigurationRepository(Path configRoot) {
    ...
    public Map<String, Object> get(String id) {
        ...
        return (Map) readProperties(configRoot.resolve(id), propertiesFileName);
    }

    @Override
    public void save(String id, Map<String, Object> properties) {
        String propertiesFileName = getPropertiesFileName(id);
        writeProperties(configRoot.resolve(id), propertiesFileName, properties);
    }

    @Override
    public boolean delete(String id) {
        String propertiesFileName = getPropertiesFileName(id);
        return deleteProperties(configRoot.resolve(id), propertiesFileName);
    }
    ...
    public String getPropertiesFileName(String pluginId) {
        return pluginId.toLowerCase() + CONFIG_FILE_EXTENSION;
    }

    public Path getPropertiesPath(Path configPath, String propertiesFileName) {
