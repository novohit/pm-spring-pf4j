...
public class PmPluginClassLoader extends PluginClassLoader {

    private static final Logger log = LoggerFactory.getLogger(PmPluginClassLoader.class);

    // plugin-specific resources
    private static final Set<String> PLUGIN_FIRST_RESOURCES = Set.of("META-INF/extensions.idx");

    private final ClassLoader parentClassLoader;

    public PmPluginClassLoader(final PluginManager pluginManager, final PluginDescriptor pluginDescriptor,
