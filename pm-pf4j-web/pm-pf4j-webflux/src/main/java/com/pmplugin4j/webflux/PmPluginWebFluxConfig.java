...
public class PmPluginWebFluxConfig {
    ...
    public PmPluginWebFluxRequestMappingHandlerMapping webFluxRequestMappingHandlerMapping(
            ObjectProvider<PluginAnonymousPathRegistrar> anonymousPathRegistrar) {
        ...
        anonymousPathRegistrar.ifAvailable(webFluxHandlerMapping::setAnonymousPathRegistry);
    ...
    @Bean
    public PluginWebFluxRegistrar pluginWebFluxRegistrar() {
        return new PluginWebFluxRegistrar();
    }
