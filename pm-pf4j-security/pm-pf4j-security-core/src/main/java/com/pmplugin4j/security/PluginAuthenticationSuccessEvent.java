...
/**
 * Published when a plugin {@code IPluginAuthenticationProvider} successfully authenticates a request.
 * <p>
 * Host applications can listen via {@code @EventListener}: <pre>{@code
 * &#64;EventListener
...
public class PluginAuthenticationSuccessEvent extends PluginAuthenticationEvent {
    ...
    public PluginAuthenticationSuccessEvent(Object source, String pluginId, String providerName, long durationMs,
