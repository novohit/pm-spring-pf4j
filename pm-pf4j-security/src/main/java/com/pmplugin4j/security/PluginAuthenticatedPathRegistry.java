 ...
 * <p>
 * During request processing, the authentication filter consults this registry to distinguish OR-authentication mode
 * (session-first, then plugin auth) from exclusive-authentication mode (plugin auth only).
 */
