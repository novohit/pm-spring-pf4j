 ...
 * <p>
 * Follows a three-tier control model (inspired by Kong's "install ≠ enable"):
 * <ol>
 ...
 */
@Getter
@ConfigurationProperties(prefix = "pm.pf4j.security")
public class PluginFilterConfigProperties {
    ...
    public static class FilterConfig {
        ...
        private Set<PmPluginFilterPosition> allowedPositions = Collections.emptySet();

        public void setAllowedPositions(Set<PmPluginFilterPosition> allowedPositions) {
            this.allowedPositions = allowedPositions != null ? allowedPositions : Collections.emptySet();
        }
    }
