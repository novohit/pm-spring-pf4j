...
import com.pmplugin4j.config.PmPluginWebAutoConfiguration;
...
class PmSecurityWebFluxAutoConfigurationTest {
    ...
    private final ReactiveWebApplicationContextRunner contextRunner = new ReactiveWebApplicationContextRunner()
        .withConfiguration(AutoConfigurations.of(PmPluginWebAutoConfiguration.class, PmSecurityAutoConfiguration.class,
                PmSecurityWebFluxAutoConfiguration.class));
