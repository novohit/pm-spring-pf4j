 ...
 */
public record AnonymousPathEntry(String pluginId, String pathPattern, String httpMethod, String controllerClass,
        String methodName, String reason, LocalDateTime registeredAt) {
}
